...
console.log(cargoHold.splice(3,0,"keys"));
console.log(cargoHold);

//2) Remove ‘instruction manual’ from the array. (Hint: indexOf is helpful to avoid manually counting an index).
console.log("Remove ‘instruction manual’ from the array")
console.log(cargoHold);
let cargoIndex = cargoHold.indexOf('instruction manual');
console.log(cargoIndex);
console.log(cargoHold.splice(cargoIndex,1));
console.log(cargoHold);
